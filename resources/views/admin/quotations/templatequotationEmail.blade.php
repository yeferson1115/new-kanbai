				...
				<center>
					<table width="90%" class="tablealma">
						...
						<tr>
							...
							<center>
								<label style="margin-bottom: 7px; display: block;"><b>Nombre:</b> {{$cliente['name']}}</label>
								<label style="margin-bottom: 7px; display: block;"><b>Empresa:</b> {{$cliente['company']}}</label>
								<label style="margin-bottom: 7px; display: block;"><b>E-mail:</b> {{$cliente['email']}}</label>
								<label style="margin-bottom: 7px; display: block;"><b>Celular:</b> {{$cliente['phone']}}</label>
							</center>
							</td>
						</tr>
							...
							<td style="background-color:#ffffff;">
								<center>
									<table width="90%" class="tablealmainterna">
										...
										<tr>
											...
											<td width="20%" style="vertical-align: top;">
												<ul style="padding: 0;">
													...
													<li>{{$extra['extra']}} - ${{number_format($extra['price'], 0, 0, '.')}}</li>
													@endforeach
												</ul>
											</td>
										</tr>
										...
										<tr><td colspan="3" style="height:30px;">&nbsp;</td></tr>
										<tr>
											<td colspan="3" style="text-align: right;font-weight: bold;font-size: 20px;">
