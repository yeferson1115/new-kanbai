					...
					<table width="90%" class="tablealma">
									...
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">
												<p style="color: #616161;font-size: 16px; margin-bottom: 0px;font-weight: 900;">¡Te damos la bienvenida a Kanbai!</p>
												<br>
												<p style="color: #616161;font-size: 16px;">Estamos emocionados de que ahora seas parte de nuestra plataforma, diseñada para hacer tus compras corporativas más fáciles, rápidas y eficientes. A continuación, te compartimos tus credenciales de acceso:</p>
												<br>
											</td>
										</tr>
									</table>
						...
						<tr>
							<td>
								<center>
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#EFEFEF;border-radius: 20px; font-family: 'Raleway', sans-serif;">
												<p style="color: #616161;font-size: 16px; margin-bottom: 0px;">Usuario: <label style="font-weight: 900;">{{$user->username}}</label></p>
												
												<p style="color: #616161;font-size: 16px;">Contaseña: <label style="font-weight: 900;">{{$user->contrasena}}</label></p>
												<br>
											</td>
										</tr>
									</table>
							...
							<td>
								<center>
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">												
												<p style="color: #616161;font-size: 16px;">Ingresa ahora a <a style="color: #0563D1;font-weight: 800;" href="https://kanbai.co/login" target="_blank" rel="noopener noreferrer">kanbai.co/login</a> y empieza a disfrutar de una experiencia de compra ágil y personalizada para tu empresa</p>
												<br>
											</td>
										</tr>
									</table>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle; background-color:#ffffff;">
								<a class="button-k" href="https://kanbai.co" target="_blank" rel="noopener noreferrer" style="color: #fff !important; text-decoration: none;">Ir a Kanabai</a>
							</td>
						</tr>
						<tr>
							<td>
								<center>
									<table style="width: 90%;">
										<tr>
											<td align="center" style="background-color:#ffffff; font-family: 'Raleway', sans-serif;">												
												<p style="color: #616161;font-size: 16px;">Si tienes alguna duda o necesitas ayuda para comenzar, nuestro equipo de soporte está listo para acompañarte en cada paso.</p>
												<br>
											</td>
										</tr>
									</table>
