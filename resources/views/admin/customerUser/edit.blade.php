...
@section('title', 'Asesores Asignados')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Editar: {{ $user->name }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="/asignar-asesor">Asesores Asignados &nbsp; &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                        </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Editar Asignación de Asesor</h4>
                    </div>
                    <div class="card-body">
                         <form class="form" role="form" id="main-form" autocomplete="off">
                            <!--<input type="hidden" id="_url" value="{{ url('user',[$user->encode_id]) }}">-->
                            <input type="hidden" id="_token" value="{{ csrf_token() }}">
                            <input type="hidden" id="_url" value="{{ route('updateuser') }}">
                            <input type="hidden" id="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="id" value="{{ $user->encode_id }}">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control @error('whatsapp') is-invalid @enderror" id="whatsapp" name="whatsapp" value="{{ $user->whatsapp }}"  autocomplete="whatsapp" autofocus placeholder="whatsapp">
                                        @error('whatsapp')
                                            <span class="invalid-feedback text-center" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control @error('cellphone') is-invalid @enderror" id="cellphone" name="cellphone" value="{{ $user->cellphone }}"  autocomplete="cellphone" autofocus placeholder="Celular">
                                        @error('cellphone')
                                            <span class="invalid-feedback text-center" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"  autocomplete="description" autofocus >{{ $user->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback text-center" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="username">Nombre de Usuari</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="file" class="form-control @error('photo') is-invalid @enderror" id="photo" name="photo" value="{{ $user->photo }}"  autocomplete="cellphone" autofocus placeholder="Celular">
                                        @error('photo')
                                            <span class="invalid-feedback text-center" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
@push('scripts')
    ...
    <script src="{{ asset('js/admin/customeruser/edit.js') }}"></script>
