...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Proyectos</h2>
            ...
            <div class="col-12">
                <div class="card">                    
                    ...
                    <ul class="nav nav-pills tap-solicitudes mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-canseladas-tab" data-bs-toggle="pill" data-bs-target="#pills-canseladas" type="button" role="tab" aria-controls="pills-canseladas" aria-selected="false">Proyectos en ejecucion: {{count($ejecucion)}}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-aprobadas-tab" data-bs-toggle="pill" data-bs-target="#pills-aprobadas" type="button" role="tab" aria-controls="pills-aprobadas" aria-selected="false">Solicitudes finalizados: {{count($finalizadas)}}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-ejecucion-tab" data-bs-toggle="pill" data-bs-target="#pills-ejecucion" type="button" role="tab" aria-controls="pills-ejecucion" aria-selected="false">Solicitudes canceladas: {{count($cancelados)}}</button>
                        </li>
                        </ul>
