<form method="POST" action="">
  ...
  <div class="row">
      <div class="col-md-12 col-12">
        <div class="mb-1">
          <label class="form-label" for="deny_customer">Escribe a continuación motivo por el cual la oferta será rechazada:</label>
          <textarea class="form-control" id="deny_customer" name="deny_customer"  ></textarea>
          <span class="missing_alert text-danger" id="deny_customer_alert"></span>
        </div>
      </div>  
...
if ($('#deny_customer').val() === '') {
    $('#deny_customer_alert').text('Ingrese el motivo del rechazo').show();
    $('#deny_customer').focus();
    return false;
}
