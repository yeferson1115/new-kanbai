$(document).ready(function(){
  ...
  $('#main-form').submit(function(){
        ...
        if ($('#main-form #name').val() === '') {
            $('#main-form #name_alert').text('Ingrese nombre de la categoría').show();
        ...
        var state=$('input:radio[name=is_menu]:checked').val();
        if(state===undefined){
          $('#main-form #is_menu_alert').text('Seleccione si es menu').show();
          return false;
        }
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                if(json.success){
                  ...
                  _alertGeneric('success','Muy bien! ','Categoría creada correctamente','/categories');
                }
              },error: function (data) {
