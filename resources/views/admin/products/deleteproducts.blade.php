...
@section('page_title', 'Listado de Productos para eliminar')
@section('content')
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Productos para eliminar</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="/home">Inicio &nbsp; &nbsp;<i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                        </li>
                        <li class="breadcrumb-item active">Productos para eliminar</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Productos para eliminar</h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        <td>
                                            <form method="POST" action="">
                                                ...
                                                <div class="form-group mb-1">
                                                    <button type="submit" data-token="{{ csrf_token() }}" data-attr="{{ route('eliminar-producto') }}" class="btn btn-success waves-effect waves-float waves-light delete-user" value="Eliminar el"><i class="fa fa-check-circle-o" aria-hidden="true"></i></button>
                                                </div>
                                            </form>
                                            <form method="POST" action="">
                                                <input type="hidden" name="product_id" value="{{ $item->encode_id }}">
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" data-token="{{ csrf_token() }}" data-attr="{{ route('eliminar-producto') }}" class="btn btn-danger waves-effect waves-float waves-light delete-user" value="Rechazar la eliminación del"><i class="fa fa-times" aria-hidden="true"></i></button>
                                                </div>
                                            </form>
                                        </td>
...
<script>
    $('.delete-user').click(function(e){
        ...
        Swal.fire({
        title: 'Seguro que desea '+$(this).val()+' producto?',
        text: "",
        icon: 'warning',
