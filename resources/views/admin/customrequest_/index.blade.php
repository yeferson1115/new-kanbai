            ...
            <div class="col-12">
                <div class="card">                    
                    ...
                    <ul class="nav nav-pills tap-solicitudes mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-espera-tab" data-bs-toggle="pill" data-bs-target="#pills-espera" type="button" role="tab" aria-controls="pills-espera" aria-selected="false">Proyectos en espera: {{count($cespera)}}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-canseladas-tab" data-bs-toggle="pill" data-bs-target="#pills-canseladas" type="button" role="tab" aria-controls="pills-canseladas" aria-selected="false">Proyectos en ejecucion: {{count($cejecucion)}}</button>
                        </li>
                        <li class="nav-item" role="presentation">
