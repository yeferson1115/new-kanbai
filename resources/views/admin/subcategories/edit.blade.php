                        ...
                        <form class="form" role="form" id="main-form" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12 mb-4">
                                    ...
                                    <div class='row'>  
                                        @if(count($subcategory->banners)>0)
                                            @foreach($subcategory->banners as $item)
                                                @if($item->type==1)
                                        ...
                                        @if(count($subcategory->banners)>0)
                                            @foreach($subcategory->banners as $item)
                                                ...
                                                <div class="col-md-2 col-12">
                                                    ...
                                                    <form method="POST" action="">
                                                            <div class="form-group">
                                                                <button type="submit" data-token="{{ csrf_token() }}" data-attr="{{ url('subcategoriesbanners',[$item->encode_id]) }}" class="btn btn-danger waves-effect waves-float waves-light delete-user" value="Delete user"><i data-feather='trash-2'></i></button>
                                                            </div>
                                                    </form>
                                                </div> 
                                                @endif
    ...
    <script>
        ...
        // Add new element
            $(".add").click(function(){
                ...
                var max = 10-{{count($subcategory->banners)}};
